...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Allow remote toggle of silent mode", "Allow remote toggle of silent mode"),
        ("allow_remote_silent_toggle_tip", "Let a connected operator with full control turn silent mode on or off remotely, without visiting this machine."),
        ("remote_silent_toggle_denied_tip", "The peer refused: remote silent-mode toggle is disabled or you lack full control."),
